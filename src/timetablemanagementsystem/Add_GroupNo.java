 ...
 * @author DELL
 */
public class Add_GroupNo extends javax.swing.JFrame {

    /**
     * Creates new form Add_GroupNo
     */
    public Add_GroupNo() {
        initComponents();
        show_GroupNo();
        GroupNo.setRowHeight(30);
    }
    ...
    ResultSet rs;
     ...
     GroupNo groupNo;
     while(rs.next()){
     groupNo = new GroupNo(rs.getInt("GroupNoID"),rs.getInt("GroupNo"));
    ...
    public void show_GroupNo(){
        
    ArrayList<GroupNo> list= getGroupNoList();
    DefaultTableModel model=(DefaultTableModel)GroupNo.getModel();
    Object[] row=new Object[2];
    
    for(int i=0; i<list.size(); i++){
        
        row[0]=list.get(i).getId();
        row[1]=list.get(i).getGroupNo();
        model.addRow(row);
    }
    ...
    private void initComponents() {
        ...
        GroupNo = new javax.swing.JTable();
        ...
        GroupNoId = new javax.swing.JTextField();
        ...
        jLabel2.setText("Add Group Number Details");

        GroupNo.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        GroupNo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                GroupNoMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(GroupNo);
        ...
        GroupNumber.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        GroupNoId.setEditable(false);
        GroupNoId.setBackground(new java.awt.Color(204, 204, 204));
        GroupNoId.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        GroupNoId.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                GroupNoIdActionPerformed(evt);
            }
        });
            ...
            .addGroup(panel1Layout.createSequentialGroup()
                ...
                .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(panel1Layout.createSequentialGroup()
                        ...
                        .addComponent(GroupNumber, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel1Layout.createSequentialGroup()
                        .addComponent(jLabel3)
                        .addGap(176, 176, 176)
                        .addComponent(GroupNoId, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(panel1Layout.createSequentialGroup()
        ...
        panel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel1Layout.createSequentialGroup()
                ...
                .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(GroupNoId, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(30, 30, 30)
                .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel4)
                    .addComponent(GroupNumber, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(28, 28, 28)
        ...
        jLabel5.setText("View Group Number Details");
    ...
    private void GroupNoIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GroupNoIdActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_GroupNoIdActionPerformed

    private void AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddActionPerformed
       
        int count=0;
        String gNo=GroupNumber.getText();
        Connection connection=getConnection();
        String gnoQuery = "SELECT Count(GroupNo) FROM studentgroups WHERE GroupNo='"+gNo+"'";
        Statement st;
        ResultSet rs;
        ...
        if(GroupNumber.getText().trim().isEmpty()){
           err.setText("Please add a Group Number to continue!!!");
        }
        else if(count>0){
            
           JOptionPane.showMessageDialog(null,"Group number " +GroupNumber.getText()+" is already exists !!!");
        }

        else{
        String query = "INSERT INTO `studentgroups`(`GroupNo`) VALUES ('"+"0"+GroupNumber.getText()+"')";
        
        executeSQlQuery(query, "Group Number Inserted ");
        }
    ...
    private void EditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditActionPerformed
        ...
        String query=" UPDATE `studentgroups` SET `GroupNo`='"+GroupNumber.getText()+"' WHERE `GroupNoID` ="+GroupNoId.getText();
        executeSQlQuery(query, "Group Number Updated ");
        }
    }//GEN-LAST:event_EditActionPerformed

    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed

        String query="DELETE FROM `studentgroups` WHERE GroupNoID = "+GroupNoId.getText();
        executeSQlQuery(query, "Group Number Deleted ");
    }//GEN-LAST:event_DeleteActionPerformed

    private void GroupNoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_GroupNoMouseClicked
       
        //Display selected row in input fields
        int i= GroupNo.getSelectedRow();
        TableModel model= GroupNo.getModel();
        GroupNoId.setText(model.getValueAt(i,0).toString());
        GroupNumber.setText(model.getValueAt(i,1).toString());
    }//GEN-LAST:event_GroupNoMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_GroupNo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Add_GroupNo().setVisible(true);
            }
    ...
    private javax.swing.JTable GroupNo;
    private javax.swing.JTextField GroupNoId;
