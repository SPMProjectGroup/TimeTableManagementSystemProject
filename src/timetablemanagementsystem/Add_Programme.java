...
public class Add_Programme extends javax.swing.JFrame {
    ...
    ResultSet rs;
     ...
     Programme programme;
     while(rs.next()){
     programme = new Programme(rs.getInt("ProgrammeID"),rs.getString("ProgrammeName"));
    ...
    public void show_Programme(){
        
    ArrayList<Programme> list= getProgrammeList();
    DefaultTableModel model=(DefaultTableModel)Programme.getModel();
    ...
    private void initComponents() {
        ...
        Programme = new javax.swing.JTable();
        jButton1 = new javax.swing.JButton();
        jPanel3 = new javax.swing.JPanel();
        jLabel3 = new javax.swing.JLabel();
        jLabel4 = new javax.swing.JLabel();
        ProgrammeId = new javax.swing.JTextField();
        ...
        jLabel2.setText("View Programme Details");

        Programme.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(Programme);
        ...
        ProgrammeId.setEditable(false);
        ProgrammeId.setBackground(new java.awt.Color(204, 204, 204));
        ProgrammeId.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ProgrammeId.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ProgrammeIdActionPerformed(evt);
            }
        });

        ProgrammeName.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addComponent(ProgrammeId, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(jLabel4)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(ProgrammeName, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel3Layout.createSequentialGroup()
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(ProgrammeId, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(ProgrammeName, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(err, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel5.setText("Add Programme Details");
    ...
    private void ProgrammeIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ProgrammeIdActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ProgrammeIdActionPerformed

    private void AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddActionPerformed
        int count=0;
        String programme=ProgrammeName.getText();
        Connection connection=getConnection();
        String gnoQuery = "SELECT Count(ProgrammeName) FROM programms WHERE ProgrammeName='"+programme+"'";
        Statement st;
        ResultSet rs;
        ...
        if(ProgrammeName.getText().trim().isEmpty()){
        
            err.setText("Please add a Programme Name to continue!!!");
        }
        else if(count>0){
            
           JOptionPane.showMessageDialog(null,"Programme " +ProgrammeName.getText()+" is already exists !!!");
        }
        else{
        String query = "INSERT INTO `programms`(`ProgrammeName`) VALUES ('"+ProgrammeName.getText()+"')";

        executeSQlQuery(query, "Programme Name Inserted");
        }
    ...
    private void EditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditActionPerformed
        ...
        String query=" UPDATE `programms` SET `ProgrammeName`='"+ProgrammeName.getText()+"' WHERE `ProgrammeID` ="+ProgrammeId.getText();
        executeSQlQuery(query, "Programme Name Updated");
        }
    }//GEN-LAST:event_EditActionPerformed

    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed

        String query="DELETE FROM `programms` WHERE ProgrammeID = "+ProgrammeId.getText();
        executeSQlQuery(query, "Programme Name Deleted");
    ...
    private void ProgrammeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ProgrammeMouseClicked
        ...
        int i= Programme.getSelectedRow();
        TableModel model= Programme.getModel();
        ProgrammeId.setText(model.getValueAt(i,0).toString());
        ProgrammeName.setText(model.getValueAt(i,1).toString());
    ...
    private javax.swing.JTable Programme;
    private javax.swing.JTextField ProgrammeId;
