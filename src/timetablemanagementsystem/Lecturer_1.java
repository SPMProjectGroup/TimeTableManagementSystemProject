...
public class Lecturer_1 {
    ...
    public Lecturer_1(int TimetableID, String UserType, int NoOfWorkingDays, int WDMonday, int WDTuesday, int WDWednesday, int WDThursday, int WDFriday, int WDSaturday, int WDSunday, int WorkingHours ){
        
        this.lecturerId = TimetableID;
