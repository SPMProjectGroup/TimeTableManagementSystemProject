 ...
 * @author DELL
 */
public class Add_YearAndSemester extends javax.swing.JFrame {

    /**
     * Creates new form Add_YearAndSemester
     */
    public Add_YearAndSemester() {
        initComponents();
        show_YearAndSemester();
        YearAndSem.setRowHeight(30);
    }
    ...
    // to retrieve the year and semester table
    public ArrayList<YearAndSemester> getYearAndSemesterList(){
    
    ArrayList<YearAndSemester> YearAndSemesterList= new ArrayList<YearAndSemester>(); 
    Connection connection=getConnection();
    
    String query= "SELECT * FROM `yearsandsem` ";
    Statement st;
    ResultSet rs;
     ...
     YearAndSemester yearAndSem;
     while(rs.next()){
     yearAndSem = new YearAndSemester(rs.getInt("YearAndSemID"),rs.getString("YearAndSem"));
     YearAndSemesterList.add(yearAndSem);
     }
     }catch(Exception e){
      e.printStackTrace();
     }
    ...
    public void show_YearAndSemester(){
        
    ArrayList<YearAndSemester> list= getYearAndSemesterList();
    DefaultTableModel model=(DefaultTableModel)YearAndSem.getModel();
    ...
    private void initComponents() {
        ...
        YearAndSem = new javax.swing.JTable();
        jButton1 = new javax.swing.JButton();
        jPanel3 = new javax.swing.JPanel();
        jLabel3 = new javax.swing.JLabel();
        YearAndSemId = new javax.swing.JTextField();
        YearAndSemester = new javax.swing.JTextField();
        ...
        jLabel2.setText("Add Year and Semester Details");

        YearAndSem.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID", "Year and Semester"
            }
        ));
        YearAndSem.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                YearAndSemMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(YearAndSem);
        ...
        YearAndSemId.setEditable(false);
        YearAndSemId.setBackground(new java.awt.Color(204, 204, 204));
        YearAndSemId.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        YearAndSemId.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                YearAndSemIdActionPerformed(evt);
            }
        });

        YearAndSemester.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel4.setText("Year and Semester");
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addComponent(YearAndSemId, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(YearAndSemester, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(YearAndSemId, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(YearAndSemester, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel4))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(err, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jLabel5.setText("View Year and Semester Details");
    ...
    private void YearAndSemIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_YearAndSemIdActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_YearAndSemIdActionPerformed

    private void AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddActionPerformed
        int count=0;
        String YearandSem=YearAndSemester.getText();
        Connection connection=getConnection();
        String YearandSemQuery = "SELECT Count(YearAndSem) FROM yearsandsem WHERE YearAndSem='"+YearandSem+"'";
        Statement st;
        ResultSet rs;
        
        try{
        st= connection.createStatement();
        rs= st.executeQuery(YearandSemQuery);
        rs.next();
        count= rs.getInt(1);
        ...
        if(YearAndSemester.getText().trim().isEmpty()){
          err.setText("Please enter a Year And Semesterto continue !!!");
        }
        else if(count>0){
            
           JOptionPane.showMessageDialog(null,"Year And Semester " +YearAndSemester.getText()+" is already exists !!!");
        }
        else{
        String query = "INSERT INTO `yearsandsem`(`YearAndSem`) VALUES ('"+YearAndSemester.getText()+"')";

        executeSQlQuery(query, "Year And Semester Inserted");
        }
    ...
    private void EditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditActionPerformed
        ...
        String query=" UPDATE `yearsandsem` SET `YearAndSem`='"+YearAndSemester.getText()+"' WHERE `YearAndSemID` ="+YearAndSemId.getText();
        executeSQlQuery(query, "Year And Semester Updated");
        }
    }//GEN-LAST:event_EditActionPerformed

    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed

        String query="DELETE FROM `yearsandsem` WHERE YearAndSemID = "+YearAndSemId.getText();
        executeSQlQuery(query, "Year And Semester Deleted");
    }//GEN-LAST:event_DeleteActionPerformed

    private void YearAndSemMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_YearAndSemMouseClicked
        
        //Display selected row in input fields
        int i= YearAndSem.getSelectedRow();
        TableModel model= YearAndSem.getModel();
        YearAndSemId.setText(model.getValueAt(i,0).toString());
        YearAndSemester.setText(model.getValueAt(i,1).toString());
    }//GEN-LAST:event_YearAndSemMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_YearAndSemester.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Add_YearAndSemester().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable YearAndSem;
    private javax.swing.JTextField YearAndSemId;
    private javax.swing.JTextField YearAndSemester;
