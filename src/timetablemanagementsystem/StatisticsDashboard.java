 ...
 * @author DELL
 */
public class StatisticsDashboard extends javax.swing.JFrame {

    /**
     * Creates new form StatisticsDashboard
     */
    ...
    private void initComponents() {
        ...
        jButton_StSubjects = new javax.swing.JButton();
        jButton_StStudent = new javax.swing.JButton();
        jButton_StLecturers = new javax.swing.JButton();
        ...
        jButton_StSubjects.setBackground(new java.awt.Color(61, 42, 113));
        jButton_StSubjects.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        jButton_StSubjects.setForeground(new java.awt.Color(255, 255, 255));
        jButton_StSubjects.setText("Statistics related to Subjects ");
        jButton_StSubjects.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jButton_StSubjects.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton_StSubjectsActionPerformed(evt);
            }
        });

        jButton_StStudent.setBackground(new java.awt.Color(61, 42, 113));
        jButton_StStudent.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        jButton_StStudent.setForeground(new java.awt.Color(255, 255, 255));
        jButton_StStudent.setText("Statistics related to Students");
        jButton_StStudent.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jButton_StStudent.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton_StStudentActionPerformed(evt);
            }
        });

        jButton_StLecturers.setBackground(new java.awt.Color(61, 42, 113));
        jButton_StLecturers.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        jButton_StLecturers.setForeground(new java.awt.Color(255, 255, 255));
        jButton_StLecturers.setText("Statistics related to Lecturers ");
        jButton_StLecturers.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jButton_StLecturers.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton_StLecturersActionPerformed(evt);
            }
        });

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/timetablemanagementsystem/statistics.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jButton_StSubjects, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jButton_StLecturers, javax.swing.GroupLayout.DEFAULT_SIZE, 346, Short.MAX_VALUE)
                    .addComponent(jButton_StStudent, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(28, 28, 28)
                        .addComponent(jButton_StSubjects, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(jButton_StLecturers, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(jButton_StStudent, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(49, 49, 49)
                        .addComponent(jLabel3)
                        .addGap(9, 9, 9)
        ...
        jLabel1.setText("View Statistics for Subjects / Lecturers / Students");
    ...
    private void jButton_StSubjectsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_StSubjectsActionPerformed
        
         SubjectsStatistics subSt = new SubjectsStatistics();
         subSt.setSize(2000, 2000);
         subSt.setVisible(true); 
         this.setVisible(false); 
         this.setDefaultCloseOperation(this.EXIT_ON_CLOSE); 
         this.dispose();
    }//GEN-LAST:event_jButton_StSubjectsActionPerformed

    private void jButton_StStudentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_StStudentActionPerformed
        
         StudentStatistics stdSt = new StudentStatistics();
         stdSt.setSize(2000, 2000);
         stdSt.setVisible(true); 
         this.setVisible(false); 
         this.setDefaultCloseOperation(this.EXIT_ON_CLOSE); 
         this.dispose();
    }//GEN-LAST:event_jButton_StStudentActionPerformed

    private void jButton_StLecturersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_StLecturersActionPerformed
        
         LecturerStatistics lecSt = new LecturerStatistics();
         lecSt.setSize(2000, 2000);
         lecSt.setVisible(true); 
         this.setVisible(false); 
         this.setDefaultCloseOperation(this.EXIT_ON_CLOSE); 
         this.dispose();
    }//GEN-LAST:event_jButton_StLecturersActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StatisticsDashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StatisticsDashboard().setVisible(true);
            }
        });
        
        JFrame.setDefaultLookAndFeelDecorated(true);

        StatisticsDashboard sd = new StatisticsDashboard();
        sd.setVisible(true);
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton jButton_StLecturers;
    private javax.swing.JButton jButton_StStudent;
    private javax.swing.JButton jButton_StSubjects;
